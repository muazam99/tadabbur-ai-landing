      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose max-w-none">
          <FadeInSection delay={0.6}>
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>
                  Tadabbur does not condone and cannot be held liable for any unauthorized uploading of content that violates institutional policies, copyright law, or privacy laws. Users are fully responsible for ensuring their activities on the platform comply with all applicable legal and institutional requirements.
                </p>
                <p>
                  By using our platform, you agree to indemnify Tadabbur against any legal consequences resulting from the unauthorized distribution of material. We trust our users to respect intellectual property, privacy, and institutional policies while using Tadabbur.
                </p>
              </div>
            </section>
          </FadeInSection>
          ...
          <FadeInSection delay={0.7}>
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-black mb-4">License to View Tadabbur Content</h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Provided you comply with these Terms of Use, Tadabbur grants you a limited, personal, non-exclusive, non-commercial, revocable, and non-transferable license to access and use the content on our platform. This is strictly for personal, non-commercial, educational use.
                </p>
                <p>
                  You agree not to copy, or access content via automated means (e.g., scripts, bots, or data extraction tools) unless authorized by Tadabbur.
                </p>
                <p>
          ...
          <FadeInSection delay={0.8}>
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-black mb-4">Refund Policy for Tadabbur</h2>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-gray-700">
                    ...
                    <li>Technical issues that are caused by Tadabbur and could not be resolved within a reasonable time after the issue was reported.</li>
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Tadabbur reserves the right to modify or update this refund policy at any time. We will notify users of any significant changes by posting the updated policy on our website.
                  </p>
                </div>
              </div>
            </section>
