        ...
        <div className="prose max-w-none">
          <FadeInSection delay={0.6}>
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-black mb-4">Welcome to Tadabbur</h2>
          ...
          <FadeInSection delay={0.7}>
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Tadabbur is powered by Hashtech, a self-funded company focused on integrating tech solutions and Islam.
              </p>
            </section>
          </FadeInSection>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-3">
                    To keep Tadabbur running efficiently, we collect minimal data such as:
                  </p>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  At Tadabbur, we prioritize your privacy and don't rely on third-party "cookies" or similar tracking technologies (e.g., web beacons). However, we use in-house cookies to improve functionality and your experience:
                </p>
          ...
          <FadeInSection delay={1.5}>
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
              <p className="text-gray-700 leading-relaxed">
                <strong>Thank you for choosing Tadabbur!</strong> We're here to support you on your Quran-learning journey.
              </p>
            </div>
          </FadeInSection>
        </div>
